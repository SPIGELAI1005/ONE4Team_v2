-- One-shot fix: enable AI 4 T for TSV Allach 09 (run in Supabase SQL Editor).
...
-- 2) Feature trials — requires migration 20260614140000_club_feature_trials.sql
...
left join public.club_feature_trials t on t.club_id = c.id and t.feature in ('ai', 'multilingual')
where c.name ilike '%allach%' or c.slug ilike '%allach%';
