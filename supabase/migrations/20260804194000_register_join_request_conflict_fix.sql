-- Hotfix: remove ambiguous ON CONFLICT target in register_club_join_request.
-- Uses explicit unique constraint name to avoid PL/pgSQL variable/column ambiguity.
