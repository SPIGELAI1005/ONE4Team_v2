...
**Progress log (handoff):** See `MEMORY_BANK.md`, `PROJECT_STATUS.md`, `CHANGELOG.md`, and `TASKS.md` for dated work. **2026-07-28:** Club roles (`team_management` / `fan` / `supporter`), member photo 2-year validity, Supabase function lint repair (`20260804160000`–`20260804200000`, `db lint --linked` clean), Communication sidebar + External Bridge UX, `Ai4TLogo` on dashboard nav, Club Page Admin 5+5 tabs (`CHANGELOG.md` § 2026-07-28). **2026-05-01:** `/reports` admin KPI charts (Recharts), RBAC admin guard fallback + `20260430173000` migration, marketing footer dedupe, cookie UX refinements (`CHANGELOG.md` § 2026-05-01). **2026-05-03:** Public club microsite migrations `20260502*`–`20260503143000`, Club Page Admin publication badges + responsive preview + hero overlay settings, nav `showInNav` parity (`CHANGELOG.md` § 2026-05-03 first entry); same-day **client-only** pass: public microsite **theme contrast** + **accent hovers** on CTAs (`CHANGELOG.md` § 2026-05-03 second entry, `TASKS.md` **MICROSITE-UX-001**). **2026-06-14:** Admin dashboard live KPIs + club setup; financial P&L (`club_expenses`, `FinancialSummary`, `/reports?section=financial`); German Mitgliederliste import; role-based dashboard visibility (`CHANGELOG.md` § 2026-06-14 admin wave); **AI 4 T** rebrand, feature trials, fair-use scope, Support FAQ (`CHANGELOG.md` § 2026-06-14 AI 4 T wave). **2026-06-15:** **AI 4 T Agent** Phases 0–4 — propose/confirm/execute workflows, contextual header sheet, voice STT/TTS, NL interpret (`CHANGELOG.md` § 2026-06-15, `docs/AI4TEAM_AGENT_IMPLEMENTATION_PLAN.md`). **2026-06-24:** Training attendance RSVP on `/activities` + public club; hero team filter; AI 4 T pilot Phases 1–4 (`CHANGELOG.md` § 2026-06-24). **2026-06-25:** Messages hub, tasks, attendance overview + RSVP hardening, WhatsApp setup backlog (`CHANGELOG.md` § 2026-06-25). **2026-06-27:** TSV Allach Sommerfest tournament, online membership application, football camps, public club UX polish (`CHANGELOG.md` § 2026-06-27). **2026-06-30:** Member payments + fee packages (`/payments`), invite email (Resend Edge), production release checklist (`CHANGELOG.md` § 2026-06-30).

---

## 0) MVP decisions (locked)
- **Sport focus:** Football-first
- **Member payments:** Admin **`/payments`** — fee packages + per-member payment lines (manual tracking; club Stripe subscription separate from member collections in v1)
