...
- **ONE4AI / LLM (2026-03-28, rebranded AI4Team 2026-06-14):** Per-club AI configuration (`club_llm_settings`), reliable chat in `CoTrainer.tsx`, Settings **AI provider** card with connection status + health check. Feature trials (`club_feature_trials`) and fair-use scope on Edge. Apply migrations through **`20260614140000`**; deploy LLM Edge functions. See `CHANGELOG.md` § 2026-03-28 and § 2026-06-14 (AI4Team).
