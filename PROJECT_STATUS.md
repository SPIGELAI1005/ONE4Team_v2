...
Last updated: 2026-08-03 (Role-aware dashboards · player-focused Trainings · `/my-data` UX · LOC ~168k)
...
- **Operator LOC (2026-08-03):** **167,902** measured lines (`src/generated/app-loc.json`); Operator Financials development cost model auto-reads snapshot.
