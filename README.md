...
- **AI 4 T (`/co-trainer`)**: Club-scoped chat with structured context and fair-use scope; per-club LLM keys in **Settings → Club → AI provider**; **Agent tab** (trainer/admin); voice STT/TTS; **mobile layout (2026-07-07)** — compact empty state, fixed bottom composer, red-highlighted input row; public club modal with role-scoped Guide/Agent. See **`DEPLOYMENT.md` § AI 4 T**.
