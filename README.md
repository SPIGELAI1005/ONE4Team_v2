...
- **Pricing**: **41-day** free trial; add-on cards for Payments, Pro Comms, and **AI 4 T** (EUR 4/mo with intro video)
- **Support**: **`support@one4team.com`** (Footer, FAQ, legal pages, test banner)
- **Dashboard**: Role-based views (Admin, Trainer, Player, **Member**, Sponsor, **Supplier/partner personas**) with personalized greeting; **iOS-like mobile polish (2026-07-07)** — fixed scroll area, bottom-nav clearance, larger header icons, segment tabs on key pages; **Club page** link back to public microsite (membership or session return context); **persona-gated** messages and tasks (player = team scope + own tasks; member = club-wide announcements/general, events-only upcoming); **dual-world** club vs partner portal routes (`/partner-*`, `/supplier-page` **Partner Page**); persona switch in Settings
...
- **Teams**: Team list with **search** (name, sport, age group, league, coach, player count); **Asset Map** mobile-responsive grids and segment tabs (2026-07-07)
