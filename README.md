...
- **Communication (`/communication`)**: Club chat channels, announcements with poster upload, **message forward** to WhatsApp/native/copy with ONE4Team attribution; **External Bridge (Beta)** for WhatsApp Business API / Telegram (setup guide: **`docs/backlog/WHATSAPP_EXTERNAL_BRIDGE_SETUP.md`**)
