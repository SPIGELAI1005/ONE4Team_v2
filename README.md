...
- **Pricing**: **41-day** free trial; packages from **`plan-catalog.ts`** (Kick-off €19 + €0.15/member → Champions €149 + €0.40/member; Pro most popular); add-ons Payments, Pro Comms, **AI 4 T €19/mo** (included fair-use on Pro+); calculator defaults to Pro / 800 members
