...
Last updated: 2026-06-27 — see `CHANGELOG.md` § 2026-06-27 (TSV Allach Sommerfest + membership application **`20260627120000`**–**`20260628120000`**); § 2026-06-24 (attendance + AI 4 T pilot **`20260624120000`**–**`20260626120000`**); § 2026-06-15 (AI 4 T Agent **`20260615120000`**–**`20260615150000`**); prior § 2026-06-14 (admin financial **`20260614120000`**, AI 4 T **`20260614140000`**); operator tasks **`ALLACH-OPS-001`**, **`AI4T-P0-001`**, **`ATTEND-*`**, **`FIN-OPS-001`** in `TASKS.md`.
