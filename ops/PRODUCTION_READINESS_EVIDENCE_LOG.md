...
Last updated: 2026-07-06 — see `CHANGELOG.md` § 2026-07-06 (bug investigation remediation: communication pagination, ESLint green, password reset redirectTo, Supabase config gate, RLS workflow); § 2026-07-05 (public messaging forward/share, embedded Communication UX, microsite polish, Sommerfest mobile hero); § 2026-07-05 (Sommerfest tournament UX, public AI 4 T RBAC); § 2026-07-03 (member invite UX); § 2026-07-01 (persona scoping, partner portal); operator smokes **`OPS-AUTH-URL-001-SMOKE`**, **`COMM-FWD-SMOKE`**, **`ALLACH-SOMMERFEST-SMOKE`**, **`AI4T-PUB-RBAC-OPS`** in `TASKS.md`.
