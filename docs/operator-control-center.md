...
**Development build cost** defaults are anchored on the **measured** codebase size from `src/generated/app-loc.json` (regenerated by `npm run loc:count` / `prebuild`; **169,689** lines / **823** files as of 2026-08-03 late). Two estimation methods:
