...
**Audit date:** 2026-07-03 (updated for member invite UX, social previews, Sommerfest banner animation, dashboard club return)  
...
- **Public club microsite** — mobile header, team filter (`?team=`), RSVP on schedule/matches, Messages hub, Sommerfest live board.
