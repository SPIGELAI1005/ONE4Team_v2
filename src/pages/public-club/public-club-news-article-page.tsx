...
import { PublicClubNewsPoster } from "@/components/public-club/public-club-news-card";
...
import { findTsvAllachShowcaseNewsById, isTsvAllachShowcaseNewsId } from "@/lib/tsv-allach-public-news";
...
export default function PublicClubNewsArticlePage() {
  ...
  useEffect(() => {
    ...
    if (isTsvAllachShowcaseNewsId(newsId)) {

      const showcase = findTsvAllachShowcaseNewsById(newsId, activePageLanguage);

      setArticle(showcase ?? null);

      setNotFound(!showcase);
  ...
  }, [activePageLanguage, club?.id, newsId]);
      ...
      <div className={`${publicClubSectionContainer} py-10 sm:py-14`}>
        ...
        {loading ? (
          ...
          <article className="mx-auto max-w-4xl text-left">
            ...
            <div className="flex flex-col gap-8 overflow-hidden rounded-3xl border border-[color:var(--club-border)] bg-[color:var(--club-card)] sm:flex-row">
              ...
              <div className="flex min-w-0 flex-1 flex-col justify-center p-6 sm:p-8 lg:p-10">
                ...
                <h1 className="font-display text-3xl font-bold leading-tight text-[color:var(--club-foreground)] sm:text-4xl">
              ...
              <PublicClubNewsPoster
                ...
                className="w-full shrink-0 border-t border-[color:var(--club-border)] sm:w-[220px] sm:border-l sm:border-t-0 md:w-[260px] lg:w-[300px] aspect-[210/297]"

              />

            </div>

            <div className="mt-10 whitespace-pre-wrap text-base leading-relaxed text-[color:var(--club-foreground)]">
